...
tape( 'the function has an arity of 5', function test( t ) {
	t.strictEqual( gfirstIndexLessThan.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function returns `-1` if provided an `N` parameter which is less than or equal to zero', function test( t ) {
	...
	actual = gfirstIndexLessThan( -1, [ 1.0, 2.0, 3.0 ], 1, [ 1.0, 2.0, 3.0 ], 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
...
tape( 'the function returns `-1` if provided an `N` parameter which is less than or equal to zero (accessors)', function test( t ) {
	...
	actual = gfirstIndexLessThan( -1, toAccessorArray( [ 1.0, 2.0, 3.0 ] ), 1, toAccessorArray( [ 1.0, 2.0, 3.0 ] ), 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
...
tape( 'the function returns `-1` if comparisons involve `NaN` values', function test( t ) {
	...
	actual = gfirstIndexLessThan( 1, [ NaN ], 1, [ 0.0 ], 1 );
	t.strictEqual( actual, -1, 'returns expected value' );

	actual = gfirstIndexLessThan( 1, [ 0.0 ], 1, [ NaN ], 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
...
tape( 'the function returns `-1` if comparisons involve `NaN` values (accessors)', function test( t ) {
	...
	actual = gfirstIndexLessThan( 1, toAccessorArray( [ NaN ] ), 1, toAccessorArray( [ 0.0 ] ), 1 );
	t.strictEqual( actual, -1, 'returns expected value' );

	actual = gfirstIndexLessThan( 1, toAccessorArray( [ 0.0 ] ), 1, toAccessorArray( [ NaN ] ), 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
...
tape( 'the function treats `-0` and `+0` as equal', function test( t ) {
	...
	actual = gfirstIndexLessThan( 1, [ 0.0 ], 1, [ -0.0 ], 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
...
tape( 'the function treats `-0` and `+0` as equal (accessors)', function test( t ) {
	...
	actual = gfirstIndexLessThan( 1, toAccessorArray( [ 0.0 ] ), 1, toAccessorArray( [ -0.0 ] ), 1 );
	t.strictEqual( actual, -1, 'returns expected value' );
