...
```javascript
import gfirstIndexLessThan from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfirst-index-less-than@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfirst-index-less-than@deno/mod.js';
```
