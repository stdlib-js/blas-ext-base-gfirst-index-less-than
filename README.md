...
```javascript
import gfirstIndexLessThan from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfirst-index-less-than@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfirst-index-less-than@esm/index.mjs';
```
...
var idx = gfirstIndexLessThan( 3, x, 2, y, 2 );
// returns 2
```
...
var idx = gfirstIndexLessThan.ndarray( 3, x, 1, x.length-3, y, 1, y.length-3 );
// returns 1
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gfirst-index-less-than.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gfirst-index-less-than

[test-image]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gfirst-index-less-than/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gfirst-index-less-than?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gfirst-index-less-than.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gfirst-index-less-than/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gfirst-index-less-than/blob/esm/README.md
